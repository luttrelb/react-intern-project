...
// <video>, <img>, html tag ambiguity
const video = document.getElementById('video')
const videoClick = document.querySelector('video')

//proxy eventual completion (or failure) of an async function (interval op), returns
//function call to startVideo()
Promise.all([
  faceapi.nets.tinyFaceDetector.loadFromUri('/models'),
]).then(startVideo)

//Start video function that links the recording camera to the stream video
function startVideo() {
